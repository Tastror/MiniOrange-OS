...
global    display_int        ; add by visual 2016.5.16
global    display_str        ; add by visual 2016.5.16
...
; ====================================================================
;                              display_int        //add by visual 2016.5.16
; ====================================================================    
display_int:
    push    ebx
    mov     ebx, [esp + 8]
    mov     eax, _NR_display_int
    int     INT_VECTOR_SYS_CALL
    pop     ebx
    ret
    
; ====================================================================
;                              display_str        //add by visual 2016.5.16
; ====================================================================    
display_str:
    push    ebx
    mov     ebx, [esp + 8]
    mov     eax, _NR_display_str
    int     INT_VECTOR_SYS_CALL
    pop     ebx
    ret
